...
<dd><p>Public Key (ALA8dM36QedcUfPTNF7maThtRqHP5xvCqMsYiHUz1Rz7sPfhvCYuo)</p>
</dd>
...
<dd><p>Permissions object from Ala blockchain obtained via get_account.</p>
...
required_auth: {
  threshold: 1,
  keys: [{
      key: 'ALA78Cs5HPKY7HKHrSMnR76uj7yeajPuNwSH1Fsria3sJuufwE3Zd',
      weight: 1
    }
  ],
  accounts: []
